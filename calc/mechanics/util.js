...
if (damageGen != 8 && damageGen != 7) {
    ...
    function getFinalSpeed(gen, pokemon, field, side) {
        ...
        else if (pokemon.hasAbility('Omni-Chase') && (weather.includes('Sun') || weather.includes('Rain') || weather.includes('Sand') || weather.includes('Hail'))) {
            speedMods.push(6144);
        }
